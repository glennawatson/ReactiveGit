namespace ReactiveGit.Model
{
    ...
    public class GitCommit : IEquatable<GitCommit>, IGitIdObject
    {
        ...
        public GitCommit(IBranchManager branchManager, string sha, string messageShort, DateTime dateTime, string author, string committer, string shaShort, IReadOnlyList<string> parents)
            : this(sha, messageShort, dateTime, author, committer, shaShort, parents)
        {
        ...
        /// <param name="shaShort">The shorten version of the Sha hash.</param>
        /// <param name="parents">The parents of the commit.</param>
        public GitCommit(string sha, string messageShort, DateTime dateTime, string author, string committer, string shaShort, IReadOnlyList<string> parents)
        {
            this.Sha = sha;
